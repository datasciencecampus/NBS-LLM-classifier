...
# ISCO ---------------------------------------------------------
search_results = pd.read_csv('../data/search_results_isco.csv')
...
plt.gcf().text(0.125, 0.9, 'ISCO Q2 2024 NLFS - (sentence-transformers/all-MiniLM-L6-v2)', fontsize=9, color='#666')
plt.xlabel('Coverage')
plt.ylabel('Accuracy')
plt.text(0.02, 0.04, 
...
# ISIC ---------------------------------------------------------
search_results = pd.read_csv('../data/search_results_isic.csv')
...
plt.plot(x1, y1, marker='o', color='#6a3d9a')
plt.title('Coverage vs. Accuracy for Different Similarity Thresholds', fontsize=14, weight='bold', y=1.055, loc='left')
plt.gcf().text(0.125, 0.9, 'ISIC Q2 2024 NLFS - (sentence-transformers/all-MiniLM-L6-v2)', fontsize=9, color='#666')
plt.xlabel('Coverage')
plt.ylabel('Accuracy')
plt.text(0.02, 0.04, 
         f'cov≈0.50> (thr={z0:.2f})\ncov≈0.80> (thr={z1:.2f})', 
